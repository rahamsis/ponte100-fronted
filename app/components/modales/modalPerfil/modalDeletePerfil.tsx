import { deletePerfil } from "@/app/lib/actions"
import { DeletePerfil } from "@/types/modalPerfil"
import { useState } from "react"

export const ModalDeletePerfil = ({
  perfil,
  onSuccess,
  onClose,
  onError,
  ...
  const handleDelete = async () => {
    ...
    const result = await deletePerfil(perfil!.idPerfil)
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg max-w-lg w-full mx-3 lg:mx-0">
        ...
        <div className="flex justify-center">
          <p>¿Estás seguro de eliminar el perfil <b>{perfil?.nombrePerfil}</b>?</p>
        </div>
