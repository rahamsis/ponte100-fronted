    ...
    const actividades = [
        {
            ...
            ref: "zona",
            progress: !totalTalleresEstudio ? 0 : Math.round((totalCorrectasTalleresEstudio / totalTalleresEstudio) * 100),
            show: true,
        },
        {
            ...
            ref: "practica",
            progress: !totalPracticaUnTema ? 0 : Math.round((totalCorrectasPracticaUnTema / totalPracticaUnTema) * 100),
            show: false,
        },
        {
            ...
            ref: "generador",
            progress: !totalPrimeraPractica ? 0 : Math.round((totalCorrectasPrimeraPractica / totalPrimeraPractica) * 100),
            show: false,
        },
        {
            ...
            ref: "simulacro",
            progress: !totalSimulacros ? 0 : Math.round((totalCorrectasSimulacros / totalSimulacros) * 100),
            show: true,
        },
        {
            ...
            ref: "fallidas",
            progress: !totalPreguntasFallidas ? 0 : Math.round((totalCorrectasPreguntasFallidas / totalPreguntasFallidas) * 100),
            show: false,
        },
        {
            ...
            ref: "examenes",
            progress: !totalExamenesRepetidos ? 0 : Math.round((totalCorrectasExamenesRepetidos / totalExamenesRepetidos) * 100),
            show: true,
        },
    ]
